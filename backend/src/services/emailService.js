    ...
    // usamos gmail como servidor de correo
    ...
    // usamos el color corporativo de la plataforma
    const html = `
    ...
    // la empresa decide si mantiene o cancela el patrocinio
    ...
    // cuando alguien rellena el formulario de contacto de la web
    ...
    await transporter.sendMail({
        ...
        html,
        // respondemos al email del usuario para facilitar la respuesta
        replyTo: email,
    });
