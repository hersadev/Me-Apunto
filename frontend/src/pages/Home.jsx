...
// variable para saber si estamos en movil
...
// nombres de los dias en español
...
function Home({ estaLogueado }) {
  ...
  // vista del calendario - mes o semana
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              fontWeight: "bold",
              fontSize: esMobil ? "14px" : "20px",
              padding: esMobil ? "6px 16px" : "8px 24px",
              borderRadius: "999px",
              border: "none",
              cursor: "pointer",
              fontFamily: "'Baloo Bhai 2', Helvetica",
                  ...
                  {[...Array(diasEnMes())].map((_, i) => {
                    ...
                    return (
                      <div
                        ...
                        onMouseEnter={(e) => {
                          if (tieneEventos) e.currentTarget.style.backgroundColor = "#f5ead8";
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.backgroundColor = esHoy ? "#fdf6ec" : "transparent";
                        }}
                      >
                        <span style={{
                          fontSize: "10px",
